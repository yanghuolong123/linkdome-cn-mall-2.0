...
module.exports = {
  ...
  devServer: {
    // proxy: 'https://ai-mall.linkdome.shop/api/v1'
    ...
    proxy: 'https://dev_mall.linkdome.shop/api/v1'
    // proxy: 'https://csgc.53http.tech//api/v1'
    // proxy: 'http://en_mall.linkdome.cn/api/v1'
