...
module.exports = {
  ...
  chainWebpack: (config) => {
    ...
    config.externals({
      // echarts 体积庞大，选择将其以CDN 方式加载，因为echart会全局暴漏变量，所以在此export
      echarts: "echarts",
  ...
  pluginOptions: {
    "style-resources-loader": {
      preProcessor: "less",
      patterns: [path.resolve(__dirname, "./src/assets/css/varibles.less")],
    },
  },
  css: {
    extract: {
