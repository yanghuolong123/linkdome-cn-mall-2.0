module.exports = {
  ...
  passengerFlowachievementRateOfThisMonth:
    "enter achievement rate of this month",
  ...
  去重客流趋势: "Effective enter flow trend",
  ...
  所有从起点实体到终点实体的客流总和:
    "The sum of all passenger flows from the starting entity to the destination entity",
  进入起点的人去目的实体的平均游逛深度:
    "The average depth at which the person entering the starting point goes to the destination entity",
  为起点所有实体的客流之和:
    "Is the sum of passenger flows of all entities at the starting point",
  // pathTrendBackup.vue
  ...
  密码长度不得小于6个字符:
    "password length shall not be less than 6 characters",
  密码长度不得大于50个字符:
    "password length shall not be greater than 50 characters",
  "请输入长度为2-8的角色名称":
    "Enter a role name that contains 2 to 8 characters",
  ...
  // Entity.vue
  "确认删除此购物中心信息？":
    "Are you sure you want to delete this shopping center information?",
  ...
  首页展示图出入口坐标配置:
    "The home page display picture configures the entry and exit coordinates",
  ...
  "删除活动管理请选择最少一个！":
    "Please select at least one activity management to delete!",
  删除活动管理: "Delete activity management",
  "确定要删除所选中的活动管理？":
    "Are you sure you want to delete the selected activity management?",
  // forgetPassword
  填写邮箱: "E-Mail",
  重置密码: "Reset Password",
  完成: "Finish",
