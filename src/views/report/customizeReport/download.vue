	...
	<div class="report-center" style="min-width: 1200px;">
		<div class="pdf-text-box">
			<div id="pdfDom" v-if="showPDF" style="width: 1200px;">
				...
				<!--客流趋势  -->
				<report-chart :chartHeight='600' :clickData='clickData'  :title="$t('report.enterTrend')"
...
<!--											:page='`${10+allHeatMap.length}`'></report-table>-->
				<!-- 停留时间 业态-->
				<report-chart :chartHeight='600' :clickData='clickData'  :title="$t('report.dwellTime')" :isRemark='false'
