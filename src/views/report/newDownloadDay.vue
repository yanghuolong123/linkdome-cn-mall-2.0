  ...
  <div class="report-center">
    <div class="pdf-text-box">
      <div id="pdfDom" v-if="showPDF" style="width: 1200px;">
        ...
        <!-- 店铺 -->
        <report-chart :chartHeight='600' :clickData='clickData' title='店铺客流' page='5' :listTitle='shopTitle' :dataList='shopChartData'></report-chart>
        <!-- 楼层下的商铺 -->
        ...
        <!-- 停留时间 业态-->
        <report-chart :chartHeight='600' :clickData='clickData' title='停留时间' :isRemark='false' :page='`${10+allHeatMap.length}`'  :listTitle='dwellTitle' :dataList='dwellChartData' chartType='dwell'></report-chart>
        <!-- 停留时间 业态下的商铺-->
