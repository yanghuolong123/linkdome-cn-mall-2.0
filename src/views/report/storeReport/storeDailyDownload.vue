      ...
      <div id="pdfDom" v-if="showPDF" style="width: 1200px;">
        ...
        <div v-for="(store, i) in validStoreSelectedList">
          <report-chart
            ...
            :dataList="storeEnterChartList[i].chartData"
          ></report-chart>
          <!--门店 当日店铺入客流（表格）-->
          <report-ratio-table
          ...
          <report-chart
            ...
            :dataList="storeExitChartList[i].chartData"
          ></report-chart>
          <!--门店 当日店铺出客流（表格）-->
          <report-ratio-table
          ...
          <report-chart
            ...
            :dataList="storeTotalChartList[i].chartData"
          ></report-chart>
          <!--门店 当日店铺总客流（表格）-->
          <report-ratio-table
          ...
          <report-chart
            ...
            :dataList="storePassbyChartList[i].chartData"
          ></report-chart>
          <!--门店 当日路经客流-->
          <report-ratio-table
          ...
          <report-age-gender-chart
            ...
            :dataList="ageGenderExitChartData[i].chartData"
          ></report-age-gender-chart>
          ...
          <report-age-gender-chart
            ...
            :dataList="storeAgeGenderPssbyFlowChart[i].chartData"
          ></report-age-gender-chart>
          <report-age-gender-table
  ...
  methods: {
    ...
    reportQuery() {
      ...
      Promise.all([
        ...
        //门店数据（当日入客流）
        this.storeEnterChartList = Object.freeze(
          this.storeEnterChart(res[0].data.data)
        );
        this.storeEnterFlowList = Object.freeze(
          this.storeEnterFlow(res[0].data.data)
        );

        //门店数据（当日出客流）
        this.storeExitFlowList = Object.freeze(
          this.storeEnterFlow(res[1].data.data)
        );
        this.storeExitChartList = Object.freeze(
          this.storeEnterChart(res[1].data.data)
        );

        //总客流
        const totalData = this.getTotalFlowList(
          res[0].data.data,
          res[1].data.data
        );
        this.storeTotalFlowList = Object.freeze(this.storeEnterFlow(totalData));
        this.storeTotalChartList = Object.freeze(
          this.storeEnterChart(totalData)
        );

        //路径客流
        this.storePassbyFlowList = Object.freeze(
          this.storeEnterFlow(res[2].data.data)
        );
        this.storePassbyChartList = Object.freeze(
          this.storeEnterChart(res[2].data.data)
        );

        //门店进店年龄性别客流

        this.ageGenderChartData = Object.freeze(
          this.ageGenderList(res[3].data.data.time1, "hourly")
        );
        this.storeAgeGenderFlowList = Object.freeze(
          res[3].data.data.time1.map((o) => {
            return {
              storeName: o.name,
        ...
        this.ageGenderExitChartData = Object.freeze(
          this.ageGenderList(res[4].data.data.time1, "hourlyExit")
        );
        this.storeAgeGenderExitFlowList = Object.freeze(
          res[4].data.data.time1.map((o) => {
            return {
              storeName: o.name,
        ...
        this.storeAgeGenderPssbyFlowChart = Object.freeze(
          this.ageGenderList(res[5].data.data.time1, "passbyHourly")
        );
        this.storeAgeGenderPssbyFlowList = Object.freeze(
          res[5].data.data.time1.map((o) => {
            return {
              storeName: o.name,
