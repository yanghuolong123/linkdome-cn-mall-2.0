    ...
    <p class="text-size text-black number-con" v-if="!multiDate" >
      ...
      <template v-else>
        ...
        >
          ...
          <!-- <Tooltip :content="item.data.property" theme="light" transfer max-width="500">
            <span class="propertyName text-sm">{{item.data.property}} </span>
          </Tooltip> -->
        </span>
      </template>
    </p>
