<template>
  <div class="heatMaps">
    ...
    <div class="content">
      ...
      <div
        v-show="drainageType === 0"
        v-if="isHeatMap"
        id="passengerFlowDistribution"
        class="heatMapGrid"
...
export default {
  ...
  methods: {
    ...
    handleClick() {
      ...
      switch (this.dateType) {
        case "week":
          ...
          begin_time = moment(this.dateValue)
            .subtract(weekOfday - 1, "days")
            .format("YYYY-MM-DD"); //周一日期
          end_time = moment(this.dateValue)
    ...
    initFlowDstrbtCharts(data = [], maxAvg = 100, workingtime = []) {
      flowDistributionCharts = echarts.init(
        document.getElementById("passengerFlowDistribution")
      );
      data = data.map((item) => {
