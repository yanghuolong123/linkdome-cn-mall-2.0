...
export default {
  ...
  computed: {
    reportDate() {
      ...
      switch (type) {
        case "day":
          return this.$store.state.report.dayReportHeader.reportDate;
        case "week":
          return this.$store.state.report.weekReportHeader.reportDate;
        case "month":
          return this.$store.state.report.monthReportHeader.reportDate;
        case "customize":
...
.reportOneText {
  ...
  overflow: hidden;
  position: relative;
  background: url("../../../assets/images/fixation_img/bg/image_back_cover_background.jpg")
    no-repeat;
