        ...
        <ul class="table" style="  border: 4px dashed #4edbda;
          ...
          margin-top: 12px;">
            <li>
                <p style=" height: 45px;
                  line-height:45px;
                  font-size: 16px;" :style="{width:width}" v-for="(item,index) in tableColumn" :key="index">{{item}}</p>
            </li>
            <li v-for="(item,index) in tableData" :key="index">
                ...
                <p style=" height: 45px;
                  line-height:45px;
                  font-size: 16px;" :style="{width:width}" v-if="item.enter">{{item.enter}} {{$t('personTime')}}</p>
                <p style=" height: 45px;
                  line-height:45px;
                  font-size: 16px;" :style="{width:width}" v-if="item.peak">{{item.peak}} {{$t('personTime')}} {{item.time}}</p>
                <p style=" height: 45px;
                  line-height:45px;
                  font-size: 16px;" :style="{width:width}" v-if="item.mean">{{item.mean}} {{$t('report.personTimesPerDay')}}</p>
                <p style=" height: 45px;
                  line-height:45px;
                  font-size: 16px;" :style="{width:width}" v-if="item.source">{{item.source}}</p>
                <p style=" height: 45px;
                  line-height:45px;
                  font-size: 16px;" :style="{width:width}" v-if="item.target">{{item.target}}</p>
                <p style=" height: 45px;
                  line-height:45px;
