    ...
    data() {
        return {
            jsplumbSetting: {
                 ...
                 * radius: 圆的半径，越大圆越大
                 */
                // Endpoint: ['Dot', {radius: 2, cssClass: 'ef-dot', hoverClass: 'ef-dot-hover'}],
                /**
                 * 连线的两端端点类型：矩形
                 * height: 矩形的高
                 * width: 矩形的宽
                 ...
                 * outlineWidth: 外边线宽度
                 */
                EndpointStyle: {fill: '#AAAAAA', outlineWidth: 1},
                // 是否打开jsPlumb的内部日志记录
                LogEnabled: true,
                /**
                 * 连线的样式
                ...
                RenderMode: 'svg',
                // 鼠标滑过线的样式
                // HoverPaintStyle: {stroke: '#F18F26', strokeWidth: 2},
                // 滑过锚点效果
                // EndpointHoverStyle: {fill: 'red'}
                Scope: 'jsPlumb_DefaultScope' // 范围，具有相同scope的点才可连接
            },
            jsplumbViewOnlydSetting: {
                // 动态锚点、位置自适应
                Anchors: ['Top', 'TopCenter', 'TopRight', 'TopLeft', 'Right', 'RightMiddle', 'Bottom', 'BottomCenter', 'BottomRight', 'BottomLeft', 'Left', 'LeftMiddle'],
                // 容器ID
                Container: 'efContainer',
