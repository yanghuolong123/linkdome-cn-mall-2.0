...
export default [
    ...
    children: [
      {
        ...
        path: "analytics",
        name: "Entity",
        component: () => import("@/views/entity-analytic/index.vue"),
        meta: {
          breadcrumb: [
            { title: "DashBoard", url: "/" },
...

      {
        ...
        path: "agegender",
        name: "AgeGender",
        component: () => import("@/views/footfall-analytics/AgeGender.vue"),
        meta: {
          breadcrumb: [
      ...
      },
      {
        ...
        path: "ranking",
        name: "Ranking",
        component: () => import("@/views/footfall-analytics/Ranking.vue"),
        meta: {
          breadcrumb: [
            { title: "客流分析", url: "/" },
            { title: "客流分析", url: "/footfall" },
      ...
      },
      {
        ...
        path: "goShop",
        name: "GoShop",
        component: () => import("@/views/footfall-analytics/GoShop.vue"),
        meta: {
          breadcrumb: [
            { title: "客流分析", url: "/" },
            { title: "客流分析", url: "/footfall" },
      ...
      },
      {
        ...
        path: "heatMap",
        name: "HeatMap",
        component: () => import("@/views/footfall-analytics/heatMap.vue"),
        meta: {
          breadcrumb: [
            { title: "客流分析", url: "/" },
            { title: "客流分析", url: "/footfall" },
      ...
      },
      {
        ...
        path: "effective",
        name: "Effective",
        component: () => import("@/views/footfall-analytics/Effective.vue"),
        meta: {
          breadcrumb: [
            { title: "客流分析", url: "/" },
            { title: "客流分析", url: "/footfall" },
      ...
      },
      {
        ...
        path: "queue",
        name: "Queue",
        component: () => import("@/views/footfall-analytics/queue.vue"),
        meta: {
          breadcrumb: [
            { title: "客流分析", url: "/" },
            { title: "客流分析", url: "/footfall" },
    ...
    children: [
      {
        ...
        path: "relevance",
        name: "Relevance",
        component: () => import("@/views/footfall-analytics/Relevance.vue"),
        meta: {
          breadcrumb: [
            { title: "客流分析", url: "/" },
      ...
      },
      {
        ...
        path: "cross",
        name: "Cross",
        component: () => import("@/views/footfall-analytics/Cross.vue"),
        meta: {
          breadcrumb: [
            { title: "DashBoard", url: "/dashboard" },
            { title: "顾客行为分析", url: "/generatrix" },
      ...
      },
      {
        ...
        path: "3DPath",
        name: "3DPath",
        component: () => import("@/views/footfall-analytics/pathMap3D.vue"),
        meta: {
          breadcrumb: [
            { title: "客流分析", url: "/" },
            { title: "顾客行为分析", url: "/generatrix" },
      ...
      },
      {
        ...
        path: "drainage",
        name: "Drainage",
        component: () => import("@/views/footfall-analytics/Drainage.vue"),
        meta: {
          breadcrumb: [
            { title: "客流分析", url: "/" },
            { title: "顾客行为分析", url: "/generatrix" },
      ...
      },
      {
        ...
        path: "dwelltime",
        name: "DwellTime",
        component: () => import("@/views/footfall-analytics/DwellTime.vue"),
        meta: {
          breadcrumb: [
            { title: "DashBoard", url: "/dashboard" },
            { title: "顾客行为分析", url: "/generatrix" },
    ...
    children: [
      {
        ...
        path: "goal",
        name: "Goal",
        component: () => import("@/views/operation/Goal.vue"),
        meta: {
          breadcrumb: [
      ...
      },
      {
        ...
        component: () => import("@/views/operation/Holiday.vue"),
        meta: {
          breadcrumb: [
            { title: "Analytics", url: "/dashboard/analytics" },
            { title: "运营分析", url: "/operation" },
...

      {
        ...
        path: "sales",
        name: "SalesAnalytics",
        component: () => import("@/views/operation/Sales.vue"),
        meta: {
          breadcrumb: [
            { title: "Analytics", url: "/dashboard/analytics" },
            { title: "运营分析", url: "/operation" },
      ...
      },
      {
        ...
        path: "shopPortrait",
        name: "ShopPortrait",
        component: () => import("@/views/operation/ShopPortrait.vue"),
        meta: {
          breadcrumb: [
            { title: "Analytics", url: "/dashboard/analytics" },
            { title: "运营分析", url: "/operation" },
      ...
      },
      {
        ...
        component: () => import("@/views/operation/SalesNew.vue"),
        meta: {
          breadcrumb: [
            { title: "Analytics", url: "/dashboard/analytics" },
            { title: "运营分析", url: "/operation" },
      ...
      },
      {
        ...
        path: "changeStore",
        name: "ChangeStore",
        component: () => import("@/views/operation/ChangeStore.vue"),
        meta: {
          breadcrumb: [
            { title: "Analytics", url: "/dashboard/analytics" },
            { title: "运营分析", url: "/operation" },
      ...
      },
      {
        ...
        component: () => import("@/views/operation/CommodityAnalytics.vue"),
        meta: {
          breadcrumb: [
            { title: "Analytics", url: "/dashboard/analytics" },
            { title: "运营分析", url: "/operation" },
    ...
    children: [
      {
        ...
        component: () => import("@/views/report/storeReport/storeDaily.vue"),
        meta: {
          breadcrumb: [
            { title: "Analytics", url: "/dashboard/analytics" },
      ...
      },
      {
        ...
        path: "daily",
        name: "DailyReport",
        component: () => import("@/views/report/newDaily.vue"),
        meta: {
          breadcrumb: [
            { title: "Analytics", url: "/dashboard/analytics" },
            { title: "报告详情", url: "/report" },
      ...
      },
      {
        ...
        path: "weekly",
        name: "WeekReport",
        component: () => import("@/views/report/newWeek.vue"),
        meta: {
          breadcrumb: [
            { title: "Analytics", url: "/dashboard/analytics" },
            { title: "报告详情", url: "/report" },
      ...
      },
      {
        ...
        path: "month",
        name: "MonthReport",
        component: () => import("@/views/report/newMonthly.vue"),
        meta: {
          breadcrumb: [
            { title: "Analytics", url: "/dashboard/analytics" },
            { title: "报告详情", url: "/report" },
      ...
      },
      {
        ...
        component: () => import("@/views/report/customizeReport/report.vue"),
        meta: {
          breadcrumb: [
            { title: "Analytics", url: "/dashboard/analytics" },
            { title: "报告详情", url: "/report" },
    ...
    children: [
      {
        ...
        path: "entity",
        name: "EntityManage",
        component: () => import("@/views/admin/Entity.vue"),
        meta: {
          breadcrumb: [
            { title: "Analytics", url: "/dashboard/analytics" },
  ...
  },
  {
    ...
    component: () => import("@/views/report/newDownloadDay.vue"),
  },
  //门店报告下载
  {
  ...
  },
  {
    ...
    component: () => import("@/views/report/newDownloadWeek.vue"),
  },
  {
    ...
    component: () => import("@/views/report/newDownloadMonth.vue"),
  },
  {
    ...
    component: () => import("@/views/report/customizeReport/download.vue"),
  },
  {
